...
function u(f, a, b, d) {
    f.A.rc(f.ab, a, b, d, void 0)
}

function F(f, a, b, d) {
    f.A.ca ? u(f, a, b, d) : f.A.hf()._OnMessageFromDOM({
        type: "event",
        component: f.ab,
        handler: a,
        dispatchOpts: d || null,
...
window.Qg = class extends self.Sa {
    constructor(f, a) {
        super(f, a);
        this.ba = new Map;
        this.Pc = !0;
...
"use strict"; {
    ...
    window.ta = class g {
        constructor(c) {
            ...
            "html5" !==
            this.s && "playable-ad" !== this.s || !this.hb || alert("Exported games won't work until you upload them. (When running on the file: protocol, browsers block many features from working for security reasons.)");
        ...
        async Ad(c) {
            ...
            if ("playable-ad" === this.s) {
                ...
                this.Vb = {};
                await this.Ye();
                for (let l = 0, n = c.Ra.length; l < n; ++l) {
                    var k = c.Ra[l].toLowerCase();
                    this.Vb.hasOwnProperty(k) ? c.Ra[l] = {
                        Gg: !0,
                        Kg: this.Vb[k]
        ...
        Ac(c) {
            c = this.vb.hasOwnProperty(c) ? this.vb[c] : c.endsWith("/workermain.js") && this.vb.hasOwnProperty("workermain.js") ?
                this.vb["workermain.js"] : "playable-ad" === this.s && this.ha.hasOwnProperty(c.toLowerCase()) ? this.ha[c.toLowerCase()] : c;
            c instanceof Blob && (c = URL.createObjectURL(c));
            return c
        }
        async kc(c, k, l) {
            if (c.startsWith("blob:")) return new Worker(c, l);
            if ("cordova" === this.s && this.hb) return c = await this.xb(l.Fg ? c : this.ec + c), new Worker(URL.createObjectURL(new Blob([c], {
        ...
        async kf(c, k) {
            ...
            let n = c.hd || [],
                t = c.Ra;
            n = await Promise.all(n.map(q => this.Ea(q)));
            t = await Promise.all(t.map(q => this.Ea(q)));
            if ("cordova" === this.s)
                for (let q = 0, r = c.ic.length; q < r; ++q) {
                    const y = c.ic[q],
                        E = y[0];
                    if (E === c.fd || "scriptsInEvents.js" === E || E.endsWith("/scriptsInEvents.js")) y[1] = await this.Ea(E)
                }
            this.ub.postMessage(Object.assign(this.zd(c), {
                type: "init-runtime",
                isInWorker: !0,
                messagePort: k,
                canvas: l,
            ...
            this.yd();
            self.c3_callFunction = (q, r) => this.Oa.lf(q, r);
        ...
        async jf(c, k) {
            ...
            this.Qb = C.map(q => new q(this));
            this.yd();
            var l = c.Ra.map(q => "string" === typeof q ? (new URL(q, this.F)).toString() : q);
            Array.isArray(c.hd) && l.unshift(...c.hd);
            l = await Promise.all(l.map(q => this.Ea(q)));
            ...
            for (let [q, r] of t)
                if (r || (r = q), q === n) try {
                    r = await this.Ea(r), await b(r), "preview" !== this.s || l[q] || this.Id(q, "main script did not run to completion")
                } catch (y) {
                    this.Id(q, y)
                } else if ("scriptsInEvents.js" ===
                    q || q.endsWith("/scriptsInEvents.js")) r = await this.Ea(r), await b(r);
            ...
            }), this.Cd(), this.Ja = self.C3_CreateRuntime(c), await self.C3_InitRuntime(this.Ja,
                c))
        }
        Id(c, k) {
            this.Jb();
        ...
        async Ea(c) {
            return "cordova" === this.s && (c.startsWith("file:") || this.hb && this.qd(c)) ? (c.startsWith(this.F) && (c = c.substr(this.F.length)),
...
"use strict"; {
    ...
    f.wb(class extends self.Sa {
        ...
        pf() {
            "cordova" === this.A.s ? (document.addEventListener("pause", () => this.Kc(!0)), document.addEventListener("resume", () => this.Kc(!1))) : document.addEventListener("visibilitychange", () => this.Kc(document.hidden));
            return {
        ...
        jd() {
            ...
            window.addEventListener("focusin", g => {
                g = g.target;
                (C.has(g.tagName.toLowerCase()) || w(g)) && this.Za("keyboard-blur")
            });
        ...
        Of() {
            ...
            this.A.qc() && (-1 !== this.Pa && clearTimeout(this.Pa), this.Fd(e, g, 0))
        }
        Xf(e, g, c) {
            -1 !== this.Pa && clearTimeout(this.Pa);
            this.Pa = setTimeout(() => this.Fd(e,
                g, c), 48)
        }
        Fd(e, g, c) {
            const k = this.wa(),
        ...
        Ya(e, g) {
            if (this.rb && "pointermove" !== e) {
                var c = this.rb;
                c.gb || (L(c), c.Tb = Date.now())
            }
            c = 0;
            "mouse" === g.pointerType && (c = this.ob);
            F(this, e, {
            ...
            this.ac = this.$b = 0;
            "mouse" === g.pointerType && (c = "mousemove", "pointerdown" === e ? c = "mousedown" : "pointerup" === e && (c = "mouseup"), this.Hc(c, g, h), this.ob = g.buttons)
        }
        Ff(e) {
            this.Ia && (this.$b += this.Ia.movementX || 0, this.ac += this.Ia.movementY || 0);
            this.Ia = e;
            e = this.rb;
            if (-1 === e.Qa) {
                var g = Date.now(),
                    c = g - e.Tb,
                    k = e.vg;
                c >= k && e.Nd ? (e.Tb = g, e.gb = !0, e.Qc(), e.gb = !1) : e.Qa = self.setTimeout(e.ee, Math.max(k - c, 4))
            }
        }
        df() {
            this.Ya("pointermove", this.Ia);
            this.Ia = null
        }
        Hb(e, g) {
        ...
        lf(e, g) {
            return this.A.rd(this.ab, "js-invoke-function", {
                name: e,
                params: g
            }, void 0, void 0)
        }
        ...
        Pf(e) {
            "entered-fullscreen" ===
            e ? (f.Kb(!0), this.Xa()) : "exited-fullscreen" === e ? (f.Kb(!1), this.Xa()) : console.warn("Unknown wrapper message: ", e)
        }
    })
}
"use strict";
...
self.ta.wb(class extends self.Sa {
    constructor(f) {
        super(f, "touch");
        H(this, "request-permission", a => R(this, a))
    }
});
"use strict";
    ...
    constructor(f) {
        ...
        J(this, [
            ...
            ["request-fullscreen", a => {
                if ("windows-webview2" === this.s || "macos-wkwebview" === this.s) self.ta.Kb(!0), this.A.Nc({
                    type: "set-fullscreen",
                    fullscreen: !0
                });
                else {
            ...
            ["exit-fullscreen", () => {
                "windows-webview2" === this.s || "macos-wkwebview" === this.s ? (self.ta.Kb(!1), this.A.Nc({
                        type: "set-fullscreen",
                        fullscreen: !1
                    })) :
...
"use strict"; {
    ...
    self.da = class extends self.Sa {
        ...
        xd() {
            this.Rb || (this.Vc = !1, window.addEventListener("pointerup", this.qa, !0), window.addEventListener("touchend", this.qa, !0), window.addEventListener("click", this.qa, !0), window.addEventListener("keydown", this.qa, !0), this.Rb = !0)
        }
        bf() {
            this.Rb && (this.Vc = !0, window.removeEventListener("pointerup", this.qa, !0), window.removeEventListener("touchend",
                this.qa, !0), window.removeEventListener("click", this.qa, !0), window.removeEventListener("keydown", this.qa, !0), this.Rb = !1)
        }
        qg() {
            if (!this.Vc) {
                var a = this.f;
        ...
        async zc(a, b, d, h, m) {
            for (const p of this.D)
                if (p.Ua() === b && (p.jc() || m)) return p.Oe(h), p;
        ...
        Vf(a) {
            ...
            b.gd--;
            0 === b.gd && (b.resolve(), this.qb.delete(a))
        }
        wc(a) {
            a || (a = this.Ud);
        ...
        Da() {
            ...
            b = this.D.filter(d => d.pd()).map(d => d.Ta());
            u(this, "state", {
                tickCount: this.Vd,
                audioInstances: b,
                analysers: [...this.Ga].map(d => d.Be())
            });
            0 === b.length &&
                0 === this.Ga.size && this.Sb && (this.A.Wf(this.de), this.Sb = !1)
        }
        sc(a, b, d) {
            u(this, "trigger", {
                type: a,
        ...
        gg(a) {
            const b = a.tag;
            a = a.paused;
            for (const d of this.la(b)) a ? d.Wa() : d.Bb();
            this.Gb()
        }
        lg(a) {
            const b = a.tag;
        ...
        cf() {
            const a = {};
            for (const [b, d] of this.aa) a[b] = d.map(h => h.Ta());
            u(this, "fxstate", {
                fxstate: a
            });
            this.Xc = !1
...
self.se = class extends self.kd {
    constructor(f, a, b, d, h) {
        ...
        this.J.addEventListener("canplay", () => {
            ...
            !this.nb && this.J && (this.nb = this.W().createMediaElementSource(this.J), this.nb.connect(this.pb))
        });
        this.onended = null;
        ...
        this.J.addEventListener("error", m => {
            ...
            this.kb && (this.kb(m), this.kb = this.lb = null)
        })
    }
    c() {
        this.i.sd(this);
...
async function X(f) {
    if (f.xa) return f.xa;
    var a = f.i.A;
    if ("cordova" === a.s && a.qd(f.Aa) && a.hb) f.xa = await a.xb(f.Aa);
    else {
        a = await fetch(f.Aa);
...
"use strict"; {
    ...
    self.ld = class {
        ...
        Da(a) {
            -1 !== this.eb && a >= this.eb && (this.eb = -1, this.be && this.ma(), this.i.sc("fade-ended", this.Y, this.Nb))
        }
        oc() {
            const a = this.tb * this.zb();
            return isFinite(a) ? a : 0
        }
        td(a) {
            a = !!a;
            this.Ha !== a && (this.Ha = a, this.Lb())
        }
        Ab() {
            return this.i.Ab()
        }
        ...
        Cb(a) {
            a = !!a;
            this.ib !== a && ((this.ib = a) ? (this.B || (this.B = this.W().createPanner(), this.B.panningModel = this.i.Xd, this.B.distanceModel =
                this.i.Od, this.B.refDistance = this.i.Yd, this.B.maxDistance = this.i.Wd, this.B.rolloffFactor = this.i.$d), this.M.disconnect(), this.M.connect(this.B), this.B.connect(this.ra())) : (this.B.disconnect(), this.M.disconnect(), this.M.connect(this.ra())))
        }
        Ne(a, b, d, h, m, p) {
            this.ib && (this.ud(a, b, d), a = self.da.Qe, this.B.coneInnerAngle = a(h), this.B.coneOuterAngle = a(m), this.B.coneOuterGain = p)
        }
        ud(a, b, d) {
            this.ib && (this.ja[0] = a, this.ja[1] = b, this.ja[2] = 0, this.ia[0] = Math.cos(d), this.ia[1] = Math.sin(d), this.ia[2] = 0, this.B.setPosition(...this.ja),
...
self.te = class extends self.ld {
    ...
    Play(f, a, b) {
        ...
        if (d.currentTime !== b) try {
            ...
            console.warn(`[Construct 3] Exception seeking audio '${this.L.Ua()}' to position '${b}': `, h)
        }
        this.i.ua(d);
        this.G = this.H = !1;
        this.V = f;
...
self.ve = class extends self.ld {
    ...
    Fc(f) {
        this.G || this.ka || f.target !== this.$a || (this.H = this.Uc = !0, this.fa = -1, Z(this), this.i.sc("ended", this.Y, this.Nb))
    }
    T() {
        return !this.H && this.j && this.j.loop || this.G ? !1 : this.Uc
    }
    jc() {
    ...
    Ba() {
        let f;
        f = this.G ? this.N : this.Yb + (this.yb() - this.Zb) * this.pa;
        this.V || (f = Math.min(f, this.ea()));
        return f
    }
    Play(f, a, b, d) {
    ...
    Bb() {
        !this.G || this.H || this.T() || (Z(this), this.j =
            this.W().createBufferSource(), this.j.buffer = this.L.Z, this.j.connect(this.M), this.$a = this.j, this.j.onended = this.Xb, this.j.loop = this.V, this.Mb(), this.Fa(), this.j.start(0, this.N), this.Zb = this.yb(), this.Yb = this.N, this.G = !1)
    }
    oc() {
        return super.oc() * this.ad
    }
    Lb() {
        this.ad = this.Ha || this.Ab() ? 0 : 1;
        this.Mb()
    }
    uc(f) {
        f = !!f;
    ...
    tc(f) {
        this.H || this.T() || (this.G ? this.N = f : (this.Wa(), this.N = f, this.Bb()))
    }
    pc() {
        return this.N
    }
    vc(f) {
        f ?
            this.IsPlaying() ? (this.ka = !0, this.N = this.Ba(), this.V && (this.N %= this.ea()), this.j.stop(0)) : this.ka = !1 : this.ka && (Z(this), this.j = this.W().createBufferSource(), this.j.buffer = this.L.Z, this.j.connect(this.M), this.$a = this.j, this.j.onended = this.Xb, this.j.loop = this.V, this.Mb(), this.Fa(), this.j.start(0, this.N), this.Zb = this.yb(), this.Yb = this.N, this.ka = !1)
    }
    Dc(f) {
        super.Dc(f);
    ...
    self.me = class extends f {
        ...
        X(a, b, d, h) {
            switch (a) {
                ...
                case 1:
                    this.g[1] = b;
                    this.m(this.v.frequency, b, d, h);
                    break;
                case 2:
                    this.g[2] = b;
                    this.m(this.v.detune, b, d, h);
                    break;
                case 3:
                    this.g[3] = b;
                    this.m(this.v.Q, b, d, h);
                    break;
                case 4:
                    this.g[4] = b, this.m(this.v.gain, b, d, h)
            }
        }
    };
        ...
        X(a, b, d, h) {
            switch (a) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    this.g[3] = b / 100, this.m(this.fb.gain, b / 100, d, h)
            }
        }
    };
