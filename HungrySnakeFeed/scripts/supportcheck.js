...
!(function () {
  var e,
    ...
    r,
    n,
    o = !!document.querySelector('script[src*="kaspersky"]'),
    s = [];
  document.createElement("canvas").getContext("webgl") || s.push("WebGL"),
    "undefined" == typeof WebAssembly && s.push("WebAssembly"),
    "noModule" in HTMLScriptElement.prototype || s.push("JavaScript Modules"),
    (window["Intl"] && window["Intl"]["Segmenter"]) ||
      s.push("Internationalization support (Intl.Segmenter)"),
    window["C3_ModernJSSupport_OK"] || s.push("Modern JavaScript support"),
    0 !== s.length || o
      ? (((e = document.createElement("div")).id = "notSupportedWrap"),
        document.body.appendChild(e),
        ((t = document.createElement("h2")).id = "notSupportedTitle"),
        (t.textContent = o
          ? "Kaspersky Internet Security broke this export"
          : "Software update needed"),
        e.appendChild(t),
        ((t = document.createElement("p")).className = "notSupportedMessage"),
        (r =
        ...
        /android/i.test(n)
          ...
          : /msie/i.test(n) || /trident/i.test(n) || /edge\//i.test(n)
          ? (r +=
