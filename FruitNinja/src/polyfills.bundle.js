        ...
        function (t, n, r) {
          ...
          t.exports = function (t, n) {
            var r,
              ...
              d = t.global,
              g = t.stat;
            if ((r = d ? e : g ? e[y] || f(y, {}) : (e[y] || {}).prototype))
              for (p in n) {
                if (
                  ((l = n[p]),
                  (s = t.noTargetGet ? (v = o(r, p)) && v.value : r[p]),
                  !a(d ? p : y + (g ? "." : "#") + p, t.forced) && void 0 !== s)
                ) {
        ...
        function (t, n, r) {
          ...
          (t.exports = function (t, n, r, f) {
            var c = !!f && !!f.unsafe,
              ...
              l = !!f && !!f.noTargetGet;
            "function" == typeof r &&
              ("string" != typeof n || u(r, "name") || o(r, "name", n),
              (p(r).source = s.join("string" == typeof n ? n : ""))),
              t !== e
                ? (c ? !l && t[n] && (a = !0) : delete t[n],
                  a ? (t[n] = r) : o(t, n, r))
                : a
                ? (t[n] = r)
                : i(n, r);
        ...
        function (t, n, r) {
          var e = r(6),
            ...
            u = function (t, n) {
              var r = f[i(t)];
              return (
                r == a || (r != c && ("function" == typeof n ? e(n) : !!n))
              );
            },
