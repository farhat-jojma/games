!(function () {
  ...
  (b.register = function (e, t) {
    if (i && "loading" === document.readyState && "string" != typeof e) {
      ...
      if (r) {
        ...
        P = setTimeout(function () {
          (W[r.src] = [e, t]), o.import(r.src);
        });
      }
    } else j = void 0;
    return J.call(this, e, t);
  }),
    (b.instantiate = function (t, n) {
      var r = W[t];
      if (r) return delete W[t], r;
      var i = this;
      return new Promise(function (r, o) {
        var s = b.createScript(t);
    ...
    (b.shouldFetch = function () {
      return !1;
    }),
    "undefined" != typeof fetch && (b.fetch = fetch);
  var _ = b.instantiate,
  ...
  var F = b.instantiate;
  (b.instantiate = function (e, t) {
    var n = M.depcache[e];
    if (n) for (var r = 0; r < n.length; r++) w(this, this.resolve(n[r], e), e);
    return F.call(this, e, t);
  }),
    r &&
      "function" == typeof importScripts &&
      (b.instantiate = function (e) {
        var t = this;
    ...
    (b.set = function (e, t) {
      ...
      $ && "Module" === t[$]
        ...
        : ((n = Object.assign(Object.create(null), t)),
          $ && Object.defineProperty(n, $, { value: "Module" }));
      ...
      return (
        !i.e && !i.E && (Object.assign(i, { n, I: void 0, L: void 0, C: r }), n)
      );
    }),
    (b.has = function (e) {
      return !!this[m][e];
