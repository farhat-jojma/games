System.register([], function (e, n) {
  ...
  function t(e, n) {
    ...
    e.director.loadScene(t, null, function () {
      e.view.setDesignResolutionSize(1280, 768, 3);
    });
  }
  return (
    e("createApplication", function (e) {
      var r = e.loadJsListFile,
        i = e.fetchWasm,
        o = Promise.resolve();
      return (o = o
        .then(function () {
          return u("wait-for-ammo-instantiation");
        })
        .then(function (e) {
              ...
              (function (e) {
                ...
                return new Promise(function (e, t) {
                  if ("undefined" == typeof fsUtils || n.startsWith("http")) {
                    var r = function r() {
                        ...
                        s.open("GET", n),
                          ...
                          (s.onerror = function () {
                            i-- > 0
                              ? setTimeout(r, o)
                              : t(new Error("request settings failed!"));
                          }),
                          s.send(null);
                      },
                      i = 3,
                    ...
                    var s = fsUtils.readJsonSync(n);
                    s instanceof Error ? t(s) : ((window._CCSettings = s), e());
                  }
                });
              })()
            );
          ...
          .then(function () {
            return (
              ...
              (function (e, n, t) {
                ...
                try {
                  n.customLayers &&
                    n.customLayers.forEach(function (n) {
                ...
                .then(function () {
                  return a(n.hasResourcesBundle, n.hasStartSceneBundle);
                })
                .then(function () {
                  if (n.renderPipeline) return i.game.run();
                })
      ...
      function a(e, n) {
        Promise.resolve();
        var t = cc.AssetManager.BuiltinBundleName,
          r = t.MAIN,
          i = t.RESOURCES,
          o = t.START_SCENE,
          s = e ? [i, r] : [r];
