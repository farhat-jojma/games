var _azerionBuildVersion = "tc-71";
var _azerionIntegration = {
  ...
  playBtn: true,
  cp: false,
  build: { version: "tc-71", timeStamp: 1714406273300, h: "b70a3fba" },
  p: "gd",
  lng: null,
  gmoEnabled: false,
...
(() => {
  ...
  (function (e, t) {
    ...
    e(function (e, I) {
      ...
      function z() {
        try {
          ...
          return void 0 !== (v = e.runOnLoop || e.runOnContext)
            ? function () {
                v(n);
              }
            : t();
      ...
      function f(e, t) {
        e._state === C &&
          ((e._result = t), (e._state = B), 0 !== e._subscribers.length) &&
          _(s, e);
      }
      function g(e, t) {
      ...
      e.exports =
        ...
        (i.prototype._settledAt = function (e, t, n) {
          var i = this.promise;
          i._state === C &&
            (this._remaining--, e === L ? g(i, n) : (this._result[t] = n)),
    ...
    (o.BrandingDomain = void 0),
      ((O = o.BrandingDomain || (o.BrandingDomain = {}))[(O.Neutral = 0)] =
        "Neutral"),
      (O[(O.Yepi = 1)] = "Yepi"),
      (O[(O.Spele = 2)] = "Spele"),
    ...
    function p() {}
    (o.UtmTargets = void 0),
      ((O = o.UtmTargets || (o.UtmTargets = {}))[(O.splashscreen = 0)] =
        "splashscreen"),
      (O[(O.logo = 1)] = "logo"),
    ...
    w.loadPortalScript = function (e) {
      e &&
        ...
        -1 !== e.minijuegos.indexOf(x.getSourceSite()) &&
        ...
        e &&
          ...
          -1 !== e.kongregate.indexOf(x.getSourceSite()) &&
          m(
        ...
        e &&
          ...
          -1 !== e.newgrounds.indexOf(x.getSourceSite()) &&
          m(
    ...
    (A.preload = function (e) {
      var t = Promise.all([
        s.instance.load(
          i.KEY,
          "".concat(x.ASSET_LOCATION, "json/domains.json?v=").concat(e),
          "text/plain"
        ),
        s.instance.load(
          A.SITELOCK_PORTALS,
          "".concat(x.ASSET_LOCATION, "json/sitelock.json?v=").concat(e),
          "text/plain"
        ),
      ]);
      return (
        Promise.all([
          s.instance.load(
            ...
            "".concat(x.ASSET_LOCATION, "json/internal.json?v=").concat(e),
            "text/plain"
          ),
          s.instance.load(
            A.CONTRACTED_PORTALS_KEY,
            "".concat(x.ASSET_LOCATION, "json/contracted.json?v=").concat(e),
            "text/plain"
          ),
          s.instance.load(
            A.SPECIAL_PORTALS_KEY,
            "".concat(x.ASSET_LOCATION, "json/special.json?v=").concat(e),
            "text/plain"
          ),
        ]),
        t
      ...
      Object.defineProperty(A, "brandingLogoUrl", {
        get: function () {
          var e;
          switch (
            (x.isOnDevice() || h.isAirfi()
              ? (x.ASSET_LOCATION = "assets/")
              : "fbrq.io" === x.getSourceSite(!0) &&
                (x.ASSET_LOCATION =
                  "https://" +
    ...
    (D.loadHost = function () {
      ...
      (D.getSourceSite = function (e) {
        ...
        return (
          -1 !==
            ...
            (t = D.getUrlParameter("gd_sdk_referrer_url") || t),
      ...
      (D.ASSET_LOCATION = v.isStandAlone()
        ? "assets/"
                ...
                !function () {
                  var c,
                    ...
                    v =
                      ...
                      "object" == typeof G
                        ? (j.exports = P)
                        : void 0 === w.Tweenable && (w.Tweenable = P),
                      P);
                  function b() {}
                  function _(e, t) {
          ...
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (e) {
              switch (e.label) {
                case 0:
                  return (
                    S.showBuildInfo(window.location.search),
                    (r =
                ...
                case 1:
                  return (
                    ...
                    (t = document.getElementById("h5branding-logo")) &&
                      x.getBrandingDomain() !== o.BrandingDomain.Neutral &&
            ...
            (100 == (this.progress = e = 30 + 0.7 * e)
              ? ((t = document.querySelector("#h5branding-button")),
                this.circleLoader.animate(1, null, function () {
                  !x.inGDGameZone() && t && !0 === n.showPlayButton
                    ? (t.style.display = "block")
                    : (!x.inGDGameZone() && !1 !== n.showPlayButton) ||
                      n.onPlayButtonClick();
                }))
