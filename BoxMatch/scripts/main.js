    ...
    b = class extends self.DOMElementHandler {
      constructor(e) {
        super(e, a),
          ...
          (this._isRuntimeInWorker = !1),
          (this._supportsRvfc = !1),
          (this._postImageBitmaps = !1),
      ...
      async _OnInit(e) {
        ...
        return (
          (this._postImageBitmaps = this._isRuntimeInWorker || a),
          {
      ...
      TryPlayMedia(e) {
        this._iRuntime.TryPlayMedia(e),
          this._postImageBitmaps &&
            this._supportsRvfc &&
            -1 === e["c3_rvfcId"] &&
            (e["c3_rvfcId"] = e["requestVideoFrameCallback"](() =>
              this._OnVideoFrameCallback(e)
            ));
      }
      RemovePendingPlay(e) {
        this._iRuntime.RemovePendingPlay(e),
          this._postImageBitmaps &&
            this._supportsRvfc &&
            -1 !== e["c3_rvfcId"] &&
            (e["cancelVideoFrameCallback"](e["c3_rvfcId"]),
            (e["c3_rvfcId"] = -1));
      }
      async _OnVideoFrameCallback(e) {
        if (!this._destroyedVideos.has(e)) {
          ...
          try {
            ...
            t > e["c3_lastFrameSequence"] &&
              ((e["c3_imageBitmap"] = a), (e["c3_lastFrameSequence"] = t));
          } catch (e) {}
        }
      }
      CreateElement(e, t) {
        const a = document.createElement("video"),
          i =
            ...
            (a["playsInline"] = !0),
            (a["c3_imageBitmap"] = null),
            (a["c3_rvfcId"] = -1),
            (a["c3_sequenceNumber"] = 0),
            (a["c3_lastFrameSequence"] = -1),
            a.addEventListener("canplay", () =>
              this._SendPlaybackEvent(a, e, 0)
            ),
            a.addEventListener("canplaythrough", () =>
              this._SendPlaybackEvent(a, e, 1)
            ),
            a.addEventListener("ended", () => this._SendPlaybackEvent(a, e, 2)),
            a.addEventListener("error", () => this._SendPlaybackEvent(a, e, 3)),
            a.addEventListener("loadstart", () =>
              this._SendPlaybackEvent(a, e, 4)
            ),
            a.addEventListener("playing", () =>
              this._SendPlaybackEvent(a, e, 5)
            ),
            a.addEventListener("pause", () => this._SendPlaybackEvent(a, e, 6)),
            a.addEventListener("stalled", () =>
              this._SendPlaybackEvent(a, e, 7)
            ),
            t["autoplay"]);
        return (
          0 === i
            ? ((a.autoplay = !1), (a.preload = "none"))
            : 1 === i
            ? ((a.autoplay = !1), (a.preload = "auto"))
            : (a.autoplay = !0),
          t["src"] && (a.src = t["src"]),
          2 === i && this.TryPlayMedia(a),
          this._numVideos++,
          this._StartTicking(),
          a
        );
      ...
      _SendPlaybackEvent(e, t, a) {
        this._destroyedVideos.has(e) ||
          this.PostToRuntimeElement("playback-event", t, { type: a });
      }
      UpdateState(e, t) {}
      DestroyElement(e) {
        this.RemovePendingPlay(e),
          IsVideoPlaying(e) && e.pause(),
          (e.src = ""),
          (this._numVideos = Math.max(this._numVideos - 1, 0)),
          0 === this._numVideos && this._StopTicking(),
          this._destroyedVideos.add(e);
      }
      _OnPlay(e) {
        this.TryPlayMedia(e);
      }
      ...
      Tick() {
        const e = {},
          t = { sequenceNumber: this._sequenceNumber++, videoData: e },
          a = [],
          i = [];
        ...
        Promise.all(i).then(() => {
          this._isRuntimeInWorker
            ? this.PostToRuntime("state", t, !1, a)
            : this._PostToRuntimeMaybeSync("state", t);
        });
      }
    };
  self.RuntimeInterface.AddDOMHandlerClass(b);
