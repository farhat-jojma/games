...
function refreshLanguage() {
    switch (s_iCurLang) {
        ...
        case LANG_FR:
            {
                //FRENCH
                TEXT_GAMEOVER = "FÉLICITATIONS! TU AS GAGNÉ!";
                TEXT_LOSE = "DÉSOLÉ, LE JOUEUR %s A GAGNÉ CE JEU";
                TEXT_SCORE = "TON SCORE";
                TEXT_RESTART = "REDÉMARRER";
                TEXT_ARE_SURE = "ES-TU SÛR?";
                TEXT_SELECT_PLAYERS = "CHOISIS LE NOMBRE DE JOUEURS!";
                TEXT_SELECT_COLOR = "CHOISIS UNE COULEUR";
                TEXT_WELCOME = "BIENVENUE À QUATRE COULEURS!";
                TEXT_TUTORIAL1 = "ASSOCIEZ LES CARTES PAR COULEUR OU NOMBRE ET SOYEZ LE PREMIER À LES FINIR!\n\nLE GAGNANT SE RÉCOMPRE D'UN SCORE ÉGAL À LA VALEUR DES CARTES DE SES OPPOSANTS. ATTEIGNEZ %s POINTS POUR GAGNER LE JEU!\n\nVALEUR DES CARTES NUMÉRIQUES: NOMBRE SUR LA CARTE";
                TEXT_TUTORIAL2 = "LES CARTES D'ACTION RENOUVELERONT LE JEU!\n\nLA CARTE +2 FORCE LE JOUEUR SUIVANT À PIOCHER 2 CARTES ET PASSER SON TOUR\n\n VALEUR: +%s pts";
                TEXT_TUTORIAL3 = "LA CARTE PASSE TON TOUR FORCE LE ​​JOUEUR SUIVANT À SAUTER LE TOUR\n\nVALEUR: +%s pts";
                TEXT_TUTORIAL4 = "LA CARTE INVERSEMENT DE SENS CHANGE LE SENS DU JEU\n\nVALEUR: +%s pts";
                TEXT_TUTORIAL5 = "JOLLY PEUT TOUJOURS ÊTRE UTILISÉ SUR CHAQUE CARTE POUR CHANGER LA COULEUR POUR JOUER\n\nVALEUR: +%s pts";
                TEXT_TUTORIAL6 = "LE JOLLY +3 EST UN JOLLY SPÉCIAL QUI VOUS PERMET DE CHANGER DE COULEUR ET FORCE LE PROCHAIN ​​JOUEUR À TIRER 3 CARTES. VOUS NE DEVEZ PAS AVOIR D'ALTERNATIVES POUR UTILISER CETTE CARTE\n\nVALEUR: +%s pts";
                TEXT_TUTORIAL7 = "N'OUBLIEZ PAS D'APPUYER SUR LE BOUTON ' 1 ' LORSQUE VOUS N'ÊTES QU'UNE SEULE CARTE, SINON VOUS PRENDREZ %s CARTES DE PÉNALITÉ!";
                TEXT_PLAYER_1 = "JOUEUR 1";
                TEXT_PLAYER_2 = "JOUEUR 2";
                TEXT_PLAYER_3 = "JOUEUR 3";
                TEXT_PLAYER_4 = "JOUEUR 4";
                TEXT_ALERT_1 = "VOUS DEVEZ APPUYER SUR «1» LORSQUE VOUS RESTEZ AVEC UNE CARTE! VOUS OBTENEZ %s CARTES DE PÉNALITÉ";
                TEXT_ALERT_2 = "%s A OBTENU %s CARTES DE PÉNALITÉ POUR NE PAS DIRE ' 1 ' ";
                TEXT_PRELOADER_CONTINUE = "DÉMARRER";
                TEXT_DEVELOPED = "DÉVELOPPÉ PAR";
                TEXT_SUMMARY = "RÉSUMÉ";
                TEXT_PTS_TO_WINNER = "%s pts au gagnant";
                TEXT_WINNER = "GAGNANT!";
                TEXT_PLAYER_WON = "%s A GAGNÉ LE JEU!";
        ...
        case LANG_IT:
            {
                ...
                TEXT_LOSE = "SPIACENTE, IL GIOCATORE %s HA VINTO QUESTA PARTITA";
                TEXT_SCORE = "IL TUO PUNTEGGIO";
                TEXT_RESTART = "RICOMINCIA";
                TEXT_ARE_SURE = "SEI SICURO?";
                TEXT_SELECT_PLAYERS = "SCEGLI IL NUMERO DI GIOCATORI!";
                TEXT_SELECT_COLOR = "SCEGLI UN COLORE!";
                TEXT_WELCOME = "BENVENUTI IN QUATTRO COLORI ";
                TEXT_TUTORIAL1 = "ACCOPPIA LE CARTE PER COLORE O NUMERO E SII IL PRIMO A FINIRLE!\n\nAL VINCITORE VERRA' ATTRIBUITO UN PUNTEGGIO UGUALE AL VALORE DELLE CARTE DEI SUOI AVVERSARI. RAGGIUNGI %s PUNTI PER VINCERE IL GIOCO!\n\nVALORE DELLE CARTE NUMERICHE: CIFRA SULLA CARTA";
                TEXT_TUTORIAL2 = "LE CARTE SPECIALI RAVVIVERANNO IL GIOCO!\n\nIL +2 OBBLIGA IL GIOCATORE SUCCESSIVO A PESCARE DUE CARTE E SALTARE IL TURNO\n\nVALORE: +%s pti";
                TEXT_TUTORIAL3 = "LA CARTA STOP FERMA IL GIOCATORE SUCCESSIVO\n\nVALORE: +%s pti";
                TEXT_TUTORIAL4 = "LA CARTA CAMBIO GIRO INVERTE IL SENSO DI GIOCO\n\nVALORE: +%s pti";
                TEXT_TUTORIAL5 = "IL JOLLY PUO' ESSERE USATO SEMPRE E SU OGNI CARTA PER CAMBIARE IL COLORE DA GIOCARE\n\nVALORE: +%s pti";
                TEXT_TUTORIAL6 = "IL JOLLY +3 E' UN JOLLY SPECIALE CHE TI PERMETTE DI CAMBIARE COLORE E OBBLIGA IL GIOCATORE SUCCESSIVO A PESCARE 3 CARTE. PER USARE QUESTA CARTA NON DEVI AVERE ALTERNATIVE\n\nVALORE: +%s pti";
                TEXT_TUTORIAL7 = "NON DIMENTICARE DI PREMERE IL BOTTORE ' 1 ' QUANDO TI RIMANE SOLO UNA CARTA ALTRIMENTI PRENDERAI %s CARTE DI PENALITA'!";
                TEXT_PLAYER_1 = "GIOCATORE 1";
                TEXT_PLAYER_2 = "GIOCATORE 2";
                TEXT_PLAYER_3 = "GIOCATORE 3";
                TEXT_PLAYER_4 = "GIOCATORE 4";
                TEXT_ALERT_1 = "DEVI PREMERE '1' QUANDO RIMANI CON UNA CARTA! PESCA %s CARTE PENALITA'";
                TEXT_ALERT_2 = "%s PESCA %s CARTE PENALITA' PER NON AVER DETTO ' 1 ' ";
                TEXT_PRELOADER_CONTINUE = "GIOCA";
                TEXT_DEVELOPED = "CREATO DA:";
                TEXT_SUMMARY = "RIEPILOGO";
                TEXT_PTS_TO_WINNER = "%s pti al vincitore";
                TEXT_WINNER = "VINCITORE!";
                TEXT_PLAYER_WON = "%s HA VINTO IL GIOCO!";
        ...
        case LANG_RU:
            {
                ...
                TEXT_TUTORIAL6 = "«ТЯНИ ЧЕТЫРЕ» — ОСОБАЯ КАРТА. С НЕЙ ВЫ МОЖЕТЕ ПОМЕНЯТЬ ЦВЕТ, А СЛЕДУЮЩЕМУ ИГРОКУ ПРИДЕТСЯ ТЯНУТЬ 4 КАРТЫ. НО ИСПОЛЬЗОВАТЬ ЕЕ МОЖНО ТОЛЬКО ТОГДА, КОГДА У ВАС НЕТ ДРУГИХ ХОДОВ.\n\nЦЕННОСТЬ: +%s очков";
