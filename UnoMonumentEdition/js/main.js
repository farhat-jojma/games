...
(function() {
    ...
    function f(l, E) {
        for (var F in l) y.call(l, F) && E(l[F], F, l)
    }
    ...
    function n(l) {
        ...
        G && (G = [G]);
        P && !H && (H = E([P]));
        if (q = /\bGoogle TV\b/.exec(H)) H = q[0];
        ...
        if (q = "iCab" == G && 3 < parseFloat(A) && "WebKit" || /\bOpera\b/.test(B) && (/\bOPR\b/.test(l) ? "Blink" : "Presto") || /\b(?:Midori|Nook|Safari)\b/i.test(l) && !/^(?:Trident|EdgeHTML)$/.test(G) && "WebKit" || !G && /\bMSIE\b/i.test(l) && ("Mac OS" == C ? "Tasman" : "Trident") || "WebKit" == G && /\bPlayStation\b(?! Vita\b)/i.test(B) && "NetFront") G = [q];
        ...
        if (T) {
            if (e(w, "global"))
                if (Q && (q = Q.lang.System, W = q.getProperty("os.arch"), C = C || q.getProperty("os.name") + " " + q.getProperty("os.version")), M) {
                    try {
                        A = w.require("ringo/engine").version.join("."), B = "RingoJS"
                    } catch (N) {
            ...
            else d(q = w.runtime) == L ? (B = "Adobe AIR", C = q.flash.system.Capabilities.os) : d(q = w.phantom) == U ? (B = "PhantomJS", A = (q = q.version || null) && q.major + "." + q.minor +
        ...
        else if ("Maxthon" == B && A) A = A.replace(/\.[\d.]+/, ".x");
        else if (/\bXbox\b/i.test(H)) "Xbox 360" == H && (C = null), "Xbox 360" == H && /\bIEMobile\b/.test(l) && u.unshift("mobile mode");
        ...
        if (q = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(l) || 0)[1]) {
            ...
            if ("Safari" == B && "+" == q[1].slice(-1)) B = "WebKit Nightly", X = "alpha", A = q[1].slice(0, -1);
            else if (A ==
                q[1] || A == (q[2] = (/\bSafari\/([\d.]+\+?)/i.exec(l) || 0)[1])) A = null;
    ...
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        c = function() {
            for (var e, k = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "), "webkitRequestFullScreen webkitCancelFullScreen webkitCurrentFullScreenElement webkitCancelFullScreen webkitfullscreenchange webkitfullscreenerror".split(" "),
                ...
                ], g = 0, n = k.length, m = {}; g < n; g++)
                if ((e = k[g]) && e[1] in a) {
                    for (g = 0; g < e.length; g++) m[k[0][g]] = e[g];
                    return m
                }
            return !1
        }(),
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        } else f < b && (d = b - f, f += d, c += CANVAS_HEIGHT / CANVAS_WIDTH * d);
        d = a / 2 - c / 2;
        var e = b / 2 - f / 2,
            k = CANVAS_WIDTH / f;
        if (e * k < -EDGEBOARD_X ||
            d * k < -EDGEBOARD_Y) c = Math.min(a / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y), b / (CANVAS_WIDTH - 2 * EDGEBOARD_X)), f = Math.round(CANVAS_WIDTH * c), c = Math.round(CANVAS_HEIGHT * c), d = (a - c) / 2, e = (b - f) / 2, k = CANVAS_WIDTH / f;
        s_iOffsetX = -1 * e * k;
        s_iOffsetY = -1 * d * k;
        0 <= d && (s_iOffsetY = 0);
        0 <= e && (s_iOffsetX = 0);
...
function shuffle(a) {
    for (var b = a.length, c, f; 0 !== b;) f = Math.floor(Math.random() * b), --b, c = a[b], a[b] = a[f], a[f] = c;
    return a
}
...
function bubbleSort(a) {
    do {
        var b = !1;
        for (var c = 0; c < a.length - 1; c++) a[c] > a[c + 1] && (b = a[c], a[c] = a[c + 1], a[c + 1] = b, b = !0)
    } while (b)
}
...
CircularList.prototype.removeElement = function(a) {
    a = this.arr.indexOf(a); - 1 < a && this.arr.splice(a, 1)
};
    ...
    function a(d) {
        ...
        if (f[e]) e = f[e];
            ...
            for (var k = e, g, n = [], m = 0; k;) {
                if (null !== (g = c.text.exec(k))) n.push(g[0]);
                else if (null !== (g = c.modulo.exec(k))) n.push("%");
                    ...
                    if (g[2]) {
                        ...
                        if (null !== (h = c.key.exec(p)))
                            for (r.push(h[1]);
                                "" !== (p = p.substring(h[0].length));)
                                if (null !== (h = c.key_access.exec(p))) r.push(h[1]);
                                else if (null !== (h = c.index_access.exec(p))) r.push(h[1]);
                        else throw new SyntaxError("[sprintf] failed to parse named argument key");
                        else throw new SyntaxError("[sprintf] failed to parse named argument key");
                        g[2] = r
                    } else m |= 2;
                    if (3 === m) throw Error("[sprintf] mixing positional and named placeholders is not (yet) supported");
                    n.push({
                        placeholder: g[0],
                        param_no: g[1],
                        keys: g[2],
        ...
        var t, x;
        for (p = 0; p < n; p++)
            if ("string" === typeof e[p]) r += e[p];
            else if ("object" === typeof e[p]) {
            h = e[p];
            if (h.keys)
                for (m = k[g], t = 0; t < h.keys.length; t++) {
                    if (void 0 == m) throw Error(a('[sprintf] Cannot access property "%s" of undefined value "%s"', h.keys[t], h.keys[t - 1]));
                    m = m[h.keys[t]]
                } else m = h.param_no ? k[h.param_no] : k[g++];
            c.not_type.test(h.type) && c.not_primitive.test(h.type) && m instanceof Function && (m = m());
            if (c.numeric_arg.test(h.type) && "number" !== typeof m && isNaN(m)) throw new TypeError(a("[sprintf] expecting number but found %T", m));
            ...
            if (c.json.test(h.type)) r +=
                m;
            else {
                if (!c.number.test(h.type) || x && !h.sign) var y = "";
                else y = x ? "+" : "-", m = m.toString().replace(c.sign, "");
...
var s_bMobile, s_bAudioActive = !1,
    ...
    s_oCanvas, s_bFirstGame = !0,
    s_aSounds, s_aSoundsInfo, s_oGame, s_iCurLang = LANG_EN;
    ...
    this.loadPage = function(g) {
        switch (g) {
            ...
            case 5:
                ...
                break;
            case 6:
                c.setVisible(!1), new CTLText(k, -80, -120, 300, 240, 50, "center", "#fff", PRIMARY_FONT, 1.2, 0, 0, sprintf(TEXT_TUTORIAL7, NUM_PENALTY_CARDS), !0, !0, !0, !1), g = new createBitmap(s_oSpriteLibrary.getSprite("but_uno")), g.regX = 50, g.regY = 50.5, g.x = -215, g.scaleX = 1.5, g.scaleY = 1.5, k.addChild(g)
        }
    };
...
function CTurnManager() {
    ...
    this.init = function() {
        a = !0;
        for (var e = [], k = 0; k < NUM_PLAYERS; k++) e.push(k);
    ...
    this.setFirstPlayerToBegin = function() {
        do f++, f === NUM_PLAYERS && (f = 0); while (null === d.setCurrent(f));
        this.setTurn(f)
    };
...
function CMenu() {
    var a, b, c, f, d, e, k, g, n, m, r, p, h, t, x, y = null,
        v = null;
    this._init = function() {
        ...
        k = z.width / 2 + 10;
        g = z.height / 2 + 10;
        h = new CGfxButton(CANVAS_WIDTH / 2, CANVAS_HEIGHT - 240, z, s_oStage);
        h.addEventListener(ON_MOUSE_UP, this._onCreditsBut,
            this);
        ...
        y && screenfull.isEnabled && (z = s_oSpriteLibrary.getSprite("but_fullscreen"), c = k + z.width / 2, f = g, x = new CToggle(c, f, z, s_bFullscreen, s_oStage), x.addEventListener(ON_MOUSE_UP, this._onFullscreen, this));
    ...
    this.refreshButtonPos = function() {
        h.setPosition(k + s_iOffsetX, s_iOffsetY + g);
...
function CSelectPlayers() {
    var a, b, c, f, d, e, k, g, n, m, r, p, h, t, x = null,
        y = null,
        v, z;
    this._init = function() {
...
function CDeckDisplayer(a, b, c, f) {
    ...
    this.initializeDeck = function() {
        for (var p, h = 0, t, x = 0; 4 > x; x++)
            for (var y = 0; 10 > y; y++) p = y, t = 13 * x + p, d.push(new CCard(0, 0, e, t, p, x, h++, 0));
        for (x = 0; 4 > x; x++)
            for (y = 0; 9 > y; y++) p = y + 1, t = 13 * x + p, d.push(new CCard(0, 0, e, t, p, x, h++, 0));
        for (x = 0; 4 > x; x++)
            for (y = 0; 2 > y; y++) d.push(new CCard(0, 0, e, 13 * x + 10, 10, x, h++, 0)), d.push(new CCard(0, 0, e, 13 * x + 11, 11, x, h++, 0)), d.push(new CCard(0, 0, e, 13 * x + 12, 12, x, h++, 0));
        for (x = 0; 4 > x; x++) d.push(new CCard(0, 0, e, FOTOGRAM_COLOR, 13, 4, h++, 0)), d.push(new CCard(0,
    ...
    this.clearCards = function() {
        for (var p = 0; p < d.length; p++) d[p].unload();
        d = []
    };
    ...
    this.removeAllCardUnderTheDeck = function() {
        for (var p = [], h = 0; h < d.length - 1; h++) d[h].unload(), p.push(d.shift()), h--;
        return p
    };
    this._init()
}
...
function CHandDisplayer(a, b, c, f, d, e, k, g) {
        ...
        function(w, u, D, A, K) {
            ...
            switch (p) {
                ...
                case LEFT:
                    ...
                    break;
                case RIGHT:
                    r = -u, L = t.x - 140, M = t.y, y.setPosition(t.x - 20, t.y, p)
            }
            x.setPosition(L, M, p)
        };
    this.clearCards = function() {
        for (var w = 0; w < h.length; w++) h[w].unload();
        h = []
    };
    this.getGlobalPosition = function() {
        for (var w = 0, u = 0, D = 0; D < h.length; D++) 0 !== m ? w += CARD_WIDTH / 2 : u += CARD_HEIGHT / 2;
        return {
            x: t.x + w,
            y: t.y +
                u
    ...
    this.pushCard = function(w) {
        h.push(w);
        if (0 === r && t.y > CANVAS_HEIGHT / 2) h[h.length - 1].getCardSprite().on("mouseover",
            this.onMouseOver)
    };
    this.getContainer = function() {
        return t
    ...
    this.organizeHand = function(w) {
        ...
        if (0 !== m)
            for (w = 0; w < h.length; w++) {
                ...
                for (w = 0; w < h.length; w++) D = this.getDynamicOffset(r),
    ...
    this.showAllCards =
        function() {
            for (var w = 0; w < h.length; w++) h[w].showCard()
        };
    ...
    this.getCardByUniqueID = function(w) {
        for (var u = 0; u < h.length; u++)
            if (h[u].getUniqueID() === w) return h[u]
    };
    ...
    this.stopAllAnim = function() {
        for (var w = 0; w < h.length; w++) h[w].stopAllAnim()
    };
    this.dispose = function(w, u) {
        var D = this;
        n = !0;
        for (var A = h.length, K = 0; K < h.length; K++) h[K].dispose(w, u, 0, 400, 0).then(function() {
            A--;
            0 === A && D.clearCards()
        });
...
CGameBase.prototype.reset = function() {
    ...
    this._oUsedCards.disableInputDraw();
    for (var a = 0; a < this._aPlayersHand.length; a++) this._aPlayersHand[a].clearCards(), this._aPlayersHand[a].refreshScore();
...
CGameBase.prototype.onInputPlayer = function(a) {
    for (var b = 0; b < this._aPlayersHand[a].getLength(); b++) this._aPlayersHand[a].getCardByIndex(b).onSetTurned()
};
CGameBase.prototype.offInputPlayer = function(a) {
    for (var b = 0; b < this._aPlayersHand[a].getLength(); b++) this._aPlayersHand[a].getCardByIndex(b).offSetTurned()
};
CGameBase.prototype.setOffTurn = function() {
    for (var a = 0; a < NUM_PLAYERS; a++) this._aPlayersHand[a].setOffTurn(a), this.offInputPlayer(a)
};
...
CGameBase.prototype.cardCanBePlayed = function(a, b) {
    if (a.getFotogram() === FOTOGRAM_DRAW_FOUR) {
        ...
        c = !c
    } else c = a.getFotogram() === FOTOGRAM_COLOR ? !0 : this.cardMatchTheWaste(a);
    return c
};
CGameBase.prototype.cardMatchTheWaste = function(a) {
    var b = !1;
    if (a.getRank() === this._oUsedCards.getLastCard().getRank() || a.getSuit() === this._iCurrentColor || a.getFotogram() === FOTOGRAM_COLOR || a.getFotogram() === FOTOGRAM_DRAW_FOUR) b = !0;
    return b
};
...
CGameBase.prototype._calculateMatchScore = function() {
    for (var a = 0, b = 0; b < this._aPlayersHand.length; b++) a += this._aPlayersHand[b].calculateHandScore();
    return a
};
CGameBase.prototype._showAllPlayersCards = function() {
    for (var a = 0; a < this._aPlayersHand.length; a++) this._aPlayersHand[a].getSide() !== BOTTOM && this._aPlayersHand[a].showAllCards()
};
...
CGameBase.prototype.matchCanStart = function() {
    for (var a = !1, b = 0, c = 0; c < this._aPlayersHand.length; c++) this._aPlayersHand[c].getLength() === STARTING_NUM_CARDS && b++;
    b === NUM_PLAYERS && (a = !0);
    return a
};
...
CGameSingle.prototype.setNewGame = function() {
    for (var a = 0; a < this._aPlayersHand.length; a++) this._aPlayersHand[a].setScore(0);
...
CGameSingle.prototype._checkFirstCardEffect = function(a) {
    switch (a) {
        ...
        case EFFECT_DRAW_TWO_COLORED:
            ...
            break;
        default:
            this._oTurnManager.nextTurn(), this._iCurPlayer = this._oTurnManager.getTurn(), this._iNextPlayer = this._oTurnManager.getNextPlayer(), 0 === this._iCurPlayer ? (this.onInputPlayer(this._iCurPlayer), this._oDeck.enableInputDraw()) : this._oAIManager.selectACard(this._iCurPlayer),
                this._aPlayersHand[this._iCurPlayer].setOnTurn()
    }
};
...
CGameSingle.prototype._applySelectColor = function() {
    if (0 === this._iCurPlayer)(new CSelectColorPanel(EFFECT_SELECT_COLOR)).addEventListener(ON_COLOR_SELECTED, function(b) {
...
CGameSingle.prototype._applyDrawFourEffect = function() {
    if (0 === this._iCurPlayer)(new CSelectColorPanel(EFFECT_DRAW_FOUR)).addEventListener(ON_COLOR_SELECTED, function(b) {
...
CGameSingle.prototype.shuffleCards = function(a, b, c, f) {
    for (var d = this, e = this._oUsedCards.removeAllCardUnderTheDeck(), k = [], g = 0; g < e.length; g++) k.push(e[g].getFotogram());
...
function CInterface() {
    var a, b, c, f, d, e, k, g, n, m, r, p, h = null,
        t = null,
        x;
    this._init = function() {
        ...
        f = y.height / 2 + 10;
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) y = s_oSpriteLibrary.getSprite("audio_icon"), n = new CToggle(c, f, y, s_bAudioActive, x), n.addEventListener(ON_MOUSE_UP, this._onAudioToggle,
            this);
        y = window.document;
...
function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        g.regX = n.width / 2;
        g.regY = n.height / 2;
        c = g.on("click", this._onLogoButRelease);
        d.addChild(g);
        d.x = CANVAS_WIDTH / 2;
        d.y = CANVAS_HEIGHT +
            n.height / 2;
        ...
        m.lineWidth = 300;
        d.addChild(m);
        n = new createjs.Text("www.retrosgame.com", "30px " + PRIMARY_FONT, "#ffffff");
        n.y = 80;
        n.textAlign = "center";
    ...
    this._onLogoButRelease = function() {
        window.open("http://www.retrosgame.com/")
    };
    this._init()
}

function CSelectColorPanel(a) {
    var b, c, f, d, e, k, g = this,
        n, m, r, p;
    this._init = function() {
        c = [];
        f = [];
...
function CAIManager() {
    ...
    this.onSelectColorCpu = function(a) {
        ...
        for (var b, c = [{
            ...
            for (var d = 0; d < c.length; d++) b.getSuit() === d && c[d].iPoints++
        }
        c.sort(function(e, k) {
    ...
    this.selectACard = function(a) {
        for (var b = s_oGame.getPlayersHand(a), c = s_oGame.getCurColor(),
                f = s_oGame.getLastCard(), d = [], e = 0; e < b.getLength(); e++) 4 === b.getCardByIndex(e).getSuit() || b.getCardByIndex(e).getRank() !== f.getRank() && b.getCardByIndex(e).getSuit() !== c ? b.getCardByIndex(e).getFotogram() === FOTOGRAM_COLOR ? d.push({
...
function CSummaryPanel(a) {
    var b, c, f, d, e, k, g, n, m, r, p, h, t, x;
    this._init = function() {
        b = [];
        c = [];
        e = new createjs.Shape;
        ...
        v = 40 * z;
        d = [];
        for (var l = 0; l < z; l++) d[l] = new CPlayerInfo(0, 0, r, "szPlayerName"), d[l].setPosition(0, -v / 2 + v / (z - 1) * l, BOTTOM);
        f = "#35bd1b";
    ...
    this.reset = function() {
        ...
        x.setImage(v);
        for (v = 0; v < d.length; v++) d[v].enable(), d[v].setNameColor("#FFF")
    };
    this.show =
        function() {
            g.visible = !0;
