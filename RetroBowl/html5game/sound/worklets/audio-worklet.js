...
class _12 extends AudioWorkletProcessor {
    ...
    process(_22, _32, parameters) {
        ...
        for (let c = 0; c < _42.length; ++c) {
            const _52 = _42[c];
            for (let _62 = 0; _62 < _52.length; ++_62) _32[parameters.bypass[_62] ?? parameters.bypass[0]][c][_62] = _52[_62];
        }
        return this.__1;
    }
}
class _72 extends AudioWorkletProcessor {
    ...
    process(_22, _32, parameters) {
        ...
        for (let c = 0; c < _82.length; ++c) {
            const _52 = _82[c];
            const _b2 = _a2[c];
            for (let _62 = 0; _62 < _52.length; ++_62) _b2[_62] += _52[_62] * (gain[_62] ?? gain[0]);
        }
        return this.__1;
    }
}
...
class _83 extends AudioWorkletProcessor {
    ...
    constructor(_e2) {
        ...
        for (let c = 0; c < _f2; ++c) {
            ...
            for (let i = 0; i < _83._93; ++i) this._l3[c][i] = new _Y2(_n3[c % _n3.length][i]);
            for (let i = 0; i < _83._a3; ++i) this._m3[c][i] = new _73(_o3[c % _o3.length][i]);
        }
        this._p3(0.5);
        this._53(0.5);
        for (let c = 0; c < _f2; ++c)
