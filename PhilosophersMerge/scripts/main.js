    ...
    t = class extends self.DOMHandler {
      ...
      async _RequestMotionPermission() {
        ...
        try {
          return (
            "granted" ===
            (await self["DeviceMotionEvent"]["requestPermission"]())
          );
        } catch (e) {
          return (
...
("use strict");
{
  ...
  window.addEventListener(
    "beforeinstallprompt",
    (n) => (n.preventDefault(), (e = n), t && t._OnBeforeInstallPrompt(), !1)
  );
  const i = "browser",
    s = class extends self.DOMHandler {
      constructor(e) {
      ...
      async _OnRequestInstall() {
        if (!e) return { result: "unavailable" };
        try {
          e["prompt"]();
          return { result: (await e["userChoice"])["outcome"] };
        } catch (e) {
          return (
      ...
      _OnRequestFullscreen(e) {
        if (
          ...
          let s;
          i["requestFullscreen"]
            ? (s = i["requestFullscreen"](t))
            : i["mozRequestFullScreen"]
            ? (s = i["mozRequestFullScreen"](t))
            : i["msRequestFullscreen"]
            ? (s = i["msRequestFullscreen"](t))
